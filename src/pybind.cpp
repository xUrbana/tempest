...
PYBIND11_MODULE(_core, m)
{
    ...
    py::class_<WindObservation>(m, "WindObservation")
        ...
        .def("__repr__",
             [](const WindObservation &w) { return std::format("<WindObservation avg_mph={}>", w.avg_mph); });
    ...
    py::class_<Observation>(m, "Observation")
        ...
        .def_readwrite("wind", &Observation::wind) // Pybind automatically handles the nested type
